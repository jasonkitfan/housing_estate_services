...
import 'package:housing_estate_services/screens/facility_booking/facility_device_control.dart';
                  ...
                  return SizedBox(
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        if (event.isDone) {
                          showAlertDialog(
                              "Your section is end, Thank you for using the facility");
                          return;
                        }

                        // time section not reached yet
                        final currentTime = DateTime.now();
                        if (currentTime.isBefore(event.startTime)) {
                          showAlertDialog(
                              "Your section is coming, please wait");
                          return;
                        }
                        Navigator.push(
                          context,
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.all(4.0),
                                child: event.animation.endsWith("json")
                                    ? Lottie.network(event.animation)
                                    : Image.network(event.animation),
                              )),
                          Expanded(
                            flex: 75,
                            child: Padding(
